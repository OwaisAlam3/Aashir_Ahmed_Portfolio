          ...
          {isDesktop && (
            <motion.div className="hero-right"
              ...
              <motion.div
                ...
                transition={{ delay: 1.0, duration: .6 }}
                style={{
                  position: 'absolute',
                  bottom: '16%',
                  left: '-10%',
              ...
              >
                <div style={{
                  ...
                  <div style={{
                    width: 36, height: 36, borderRadius: 10, background: `${C.violet}20`,
                  ...
                  <div>
                    <div style={{ fontSize: 10, fontWeight: 800, color: C.text, fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: '0.05em', lineHeight: 1, textTransform: 'uppercase' }}>
                      Architecture
                    </div>
                    <div style={{ fontSize: 11, color: C.violet2, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", marginTop: 4 }}>
                      Scalable & Clean
                    </div>
                  </div>
                </div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  right: '-1%',
                  zIndex: 5,
                  animation: 'float-badge 3.5s ease-in-out infinite', animationDelay: '.8s'
                }}
              >
                <div style={{
                  background: `rgba(255, 255, 255, 0.03)`,
                  ...
                  <div style={{
                    width: 36, height: 36, borderRadius: 10, background: `${C.amber}20`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: C.amber, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", marginTop: 4 }}>
                      Top Tier Ranking
                    </div>
                  </div>
                </div>
              ...
              <motion.div
                ...
                style={{
                  ...
                  right: '-20%',
                  zIndex: 5,
                  animation: 'float-badge 4.5s ease-in-out infinite', animationDelay: '1.2s'
                }}
              >
                <div style={{
                  background: `rgba(255, 255, 255, 0.03)`,
                  backdropFilter: 'blur(20px)',
                  border: `1px solid ${C.mint}50`,
                  borderRadius: 14, padding: '12px 16px',
                  display: 'flex', alignItems: 'center', gap: 10,
                  boxShadow: '0 25px 50px -12px rgba(0,0,0,0.4)'
                }}>
                  <div style={{
                    width: 32, height: 32, borderRadius: 10, background: `${C.mint}15`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  ...
                  <div>
                    <div style={{ fontSize: 9, fontWeight: 800, color: C.text, fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: '0.05em', lineHeight: 1, textTransform: 'uppercase' }}>
                      Live Units
                    </div>
                    <div style={{ fontSize: 10, color: C.mint, fontWeight: 700, fontFamily: "'JetBrains Mono', monospace", marginTop: 3 }}>
                      400+ Deployed
                    </div>
                  </div>
                </div>
